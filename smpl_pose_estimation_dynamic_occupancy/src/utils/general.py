...
from src.utils.downloads import gsutil_getsize
...
def select_device(device=''):
    """Choose the appropriate device (GPU or CPU) for inference."""
    cuda_available = torch.cuda.is_available()
    if device and cuda_available:
        if device.lower() == 'cuda' or device.lower() == 'gpu':
            ...
            raise ValueError(f"Device type '{device}' is not supported. Please use 'cuda' or 'cpu'.")
    elif cuda_available:
